<template>
    <div class="about__page">
        <div class="page__header">
            <div class="bg">
                <img src="../assets/images/contact-us-bg.png" alt="news page bg">
                <div class="bg__gradient"></div>
            </div>

            <div class="container">
                <h4>ABOUT US</h4>
                <h1>Take your Business to new heights with Axxela</h1>
                <p>We’re a growing network of HVAC and mechanical services companies in Canada</p>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 ps-lg-5 ps-md-5">
                        <div class="deet__card">
                            ...
                            <p>We are committed to preserving customer relationships while retaining employees.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 ps-lg-5 ps-md-5">
                        <div class="deet__card">
                            ...
                            <p>We pay market prices. We love to ensure you get the financial outcome you deserve. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 ps-lg-5 ps-md-5">
                        <div class="deet__card">
                            ...
                            <p>Wide range from $250K+ to multi-millions in annual profit</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="process">
            <div class="container">
                <div class="h-bar"></div>
                <h3 class="mt-4 mb-4">Our Process: A Unique Value Creation Opportunity</h3>
                <p>We are HVAC people buying HVAC businesses so can move quickly and efficiently.  We’ve built an acquisition process around owners that respects your time and day-to-day operations. If you are interested in seeing an initial written proposal, we can provide one in 1-2 weeks with a 30-minutes call and a 2-3 years of financial statements. </p>

                <h3 class="mt-4 mb-4">What Are The Next Steps To Partnering With Axxela?</h3>
                <p class="d-block">1. Preliminary Conversation</p>
                <p class="d-block">2. Non-Disclosure Agreement</p>
                <p class="d-block">3. Share Financial Information</p>
                <p class="d-block">4. Due Diligence/ Site Visit</p>
                <p class="d-block">5. Close Deal And Transfer Funds</p>
            </div>
        </section>
    </div>
</template>
